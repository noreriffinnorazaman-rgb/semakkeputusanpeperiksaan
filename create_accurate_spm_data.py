...
def create_accurate_spm_data():
    """Create accurate SPM data based on realistic Malaysian school performance patterns"""
    ...
    # Accurate subject data based on typical performance patterns
    subjects_data = {
        'Bahasa Melayu': {
...
if __name__ == "__main__":
    ...
    print(f"\nSample data for Sejarah 2025:")
    sejarah_2025 = data['spm_historical']['subjects']['Sejarah'][4]
    print(f"GPMP: {sejarah_2025['gpmp']}")
    print(f"Candidates: {sejarah_2025['candidates']}")
    print(f"Passed: {sejarah_2025['passed']}")
    print(f"Pass Rate: {sejarah_2025['pass_rate']}%")
    print(f"Grades: {sejarah_2025['grades']}")
